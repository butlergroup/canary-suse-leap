# Welcome to the canary-suse-leap contributing guide!
...
Please reference and adhere to our [pull request template](https://github.com/butlergroup/canary-suse-leap/blob/main/.github/PULL_REQUEST_TEMPLATE.md) when filing your pull request. 
...
After review, your pull request will either be approved (in which case congratulations on your contributions :tada::tada:! The canary-suse-leap team thanks you :sparkles:), or we'll consult with you about additional changes we believe are needed.
